...
export function TextInputBlock({ block, notebookId }: InputBlockProps) {
  ...
  return (
    <div className='space-y-2'>
      <label htmlFor={`input-${block.id}`} className='block text-sm font-medium text-slate-700 dark:text-slate-300'>
...
export function CheckboxBlock({ block, notebookId }: InputBlockProps) {
  ...
  return (
    <div className='flex items-center gap-3'>
      ...
      />
      <label htmlFor={`input-${block.id}`} className='text-sm font-medium text-slate-700 dark:text-slate-300'>
...
export function SliderBlock({ block, notebookId }: InputBlockProps) {
  ...
  const value = Number.parseFloat(block.content) || min
